 ...
 <header className="text-gray-600 body-font">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
      <a className="mr-5 hover:text-gray-200 text-gray-400">First Link</a>
      <a className="mr-5 hover:text-gray-200 text-gray-400">Second Link</a>
      <a className="mr-5 hover:text-gray-200 text-gray-400">Third Link</a>
      <a className="mr-5 hover:text-gray-200 text-gray-400">Fourth Link</a>
    </nav>
    <button className="inline-flex items-center bg-blue-600  text-gray-200 border-0 py-1 px-3 focus:outline-none hover:bg-blue-400 rounded text-base mt-4 md:mt-0">Login
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -mx-4 -mb-10 text-center">
      <div className="sm:w-1/2 mb-10 px-4">
        ...
        <h2 className="title-font text-2xl font-medium text-blue-600 mt-6 mb-3">Innovators</h2>
        <p className="leading-relaxed text-base text-gray-400 ">Williamsburg occupy sustainable snackwave gochujang. Pinterest cornhole brunch, slow-carb neutra irony.</p>
      ...
      <div className="sm:w-1/2 mb-10 px-4">
        ...
        <h2 className="title-font text-2xl font-medium text-blue-600 mt-6 mb-3">Investor</h2>
        <p className="leading-relaxed text-base text-gray-400 ">Williamsburg occupy sustainable snackwave gochujang. Pinterest cornhole brunch, slow-carb neutra irony.</p>
        <button className="flex mx-auto mt-6 text-white bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded">Button</button>
      </div>
    </div>
  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap">
    <div className="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
      <div className="w-full sm:p-4 px-4 mb-6">
        <h1 className="title-font font-medium text-xl mb-2 text-blue-500">Moon hashtag pop-up try-hard offal truffaut</h1>
        <div className="leading-relaxed text-gray-400">Pour-over craft beer pug drinking vinegar live-edge gastropub, keytar neutra sustainable fingerstache kickstarter.</div>
      </div>
      <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
        <h2 className="title-font font-medium text-3xl text-red-600">2.7K</h2>
        <p className="leading-relaxed text-gray-400">Users</p>
      </div>
      <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
        <h2 className="title-font font-medium text-3xl text-red-600">1.8K</h2>
        <p className="leading-relaxed text-gray-400">Subscribes</p>
      </div>
      <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
        <h2 className="title-font font-medium text-3xl text-red-600">35</h2>
        <p className="leading-relaxed text-gray-400">Downloads</p>
      </div>
      <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
        <h2 className="title-font font-medium text-3xl text-red-600">4</h2>
        <p className="leading-relaxed text-gray-400">Products</p>
      </div>
    </div>
    <div className="lg:w-1/2 sm:w-1/2 w-full rounded-lg overflow-hidden mt-6 sm:mt-0 ml-6">
...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      ...
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-400">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven't heard of them.</p>
    </div>
      ...
      <div className="p-4 lg:w-1/2">
        <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div className="flex-grow sm:pl-8">
            <h2 className="title-font font-medium text-lg text-blue-300">Holden Caulfield</h2>
            <h3 className="text-red-500 mb-3">UI Developer</h3>
            <p className="mb-4 text-gray-300">DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
